...
const API_URL = "https://api.themoviedb.org/3/movie/upcoming?api_key=cb313fb3cff02b0c9d284d5946f767ed&language=en-US&page=1";
...
const Upcoming = () => {
  ...
  return (
    <>
      ...
      <h1 class="heading"> <span>Upcoming</span> </h1></div>
